...
- Git ([to install Git](https://git-scm.com/book/en/v2/Getting-Started-Installing-Git))
- Python: from v3.7 to v3.11 ([to intsall Python](https://www.python.org/downloads/))
