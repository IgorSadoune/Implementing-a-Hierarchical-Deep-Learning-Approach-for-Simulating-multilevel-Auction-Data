...
parser.add_argument("--min_epochs", type=int, default=8, help="Minimum number of epochs")
...
features_squeezed = np.load(os.path.join(current_path, '..', '..', 'data', 'features_squeezed.npy'))
