...
class DataTransformer(object):
    ...
    def __init__(self, max_clusters=10, weight_threshold=0.005, seed=None):
    ...
    def fit(self, raw_data, discrete_columns=()):
        ...
        self._validate_discrete_columns(raw_data, discrete_columns)
    ...
    def inverse_transform(self, data, column_transform_info_list=None, standalone=False, sigmas=None):
        ...
        column_names = []
        if standalone:
            assert column_transform_info_list is not None, "Provide column_transform_info_list"
            column_transform_info_list = column_transform_info_list
        else:
            column_transform_info_list = self.column_transform_info_list
        for column_transform_info in column_transform_info_list:
