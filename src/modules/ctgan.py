...
class Discriminator(Module):
    ...
    def __init__(self, input_dim, discriminator_dim, pac=10, seed=None):
...
class Residual(Module):
    ...
    def __init__(self, i, o, seed=None):
...
class Generator(Module):
    ...
    def __init__(self, embedding_dim, generator_dim, data_dim, seed=None):
        ...
        for item in list(generator_dim):
            seq += [Residual(dim, item, seed=self.random_state)]
            dim += item
...
class CTGAN(object):
    ...
    def __init__(self, output_info_list, embedding_dim=128, generator_dim=(256, 256), discriminator_dim=(256, 256),
    ...
    def fit(self, train_data, data_dim, epochs=None):
    ...
    def sample(self, n, condition_column=None, condition_value=None):
        ...
        for i in range(steps):
            ...
            fake = self._generator(fakez)
            fakeact = self._apply_activate(fake)
            synthetic_data.append(fakeact.detach().cpu().numpy())
