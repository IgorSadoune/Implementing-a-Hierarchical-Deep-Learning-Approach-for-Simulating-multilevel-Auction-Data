...
python3 src/scripts/ctgan_tvae_train.py --ctgan_epochs 2 --ctgan_batch_size 10 --tvae_epochs 2 --tvae_batch_size 10 --save_model
...
python3 src/scripts/msvr.py --max_epoch 10 --min_epoch 2 --patience 4 --batch_size 10 --save_model
